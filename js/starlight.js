...
var user_configuration={
	...
	initial_size:"5px", //initial size of the stars
	final_size:"8px", //final size of the stars after expansion
	expand_speed:"1s", //how fast the stars get bigger, in milliseconds
	fade_delay:"0.8s", //how long until the star fades out
	fade_duration:"0.8s", //how long the star fades for
	colors:["aqua", "white","hsla(180, 72%, 52%, 0.5)"], //The variety of colors of the stars. Can be any CSS complient color (eg. HEX, rgba, hsl)
	frequency:80, //how often a new wave of stars pop-out (in milliseconds. Bigger==longer)
